...
import simplyBlack from "../Assets/Images/image.png"
// import style2Image from "../Assets/Images/style2.jpg";
// import style3Image from "../Assets/Images/style3.jpg";

const styles = [
    { name: "Bold Purple", value: "bold-purple", image: boldPurple },
    { name: "Simply Black", value: "simply-black", image: simplyBlack },
    // { name: "Bold Purple2", value: "bold-purple2", image: boldPurple },
    // { name: "Bold Purple3", value: "bold-purple3", image: boldPurple },
    // { name: "Style 2", value: "style-2", image: style2Image },
    // { name: "Style 3", value: "style-3", image: style3Image },
];
    ...
    return (
        <div className="px-4 max-sm:p-0">
            ...
            <div className="grid grid-cols-2 gap-4 mb-8 grid-flow-row max-sm:grid-cols-1">
                {styles.map(({ name, value, image }) => (
                    <div
                        key={value}
                        className={`${value === selectedStyle && "border-2 border-gray-600"} border cursor-pointer overflow-hidden rounded hover:shadow-lg transition-all duration-200`}

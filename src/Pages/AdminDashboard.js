                ...
                {pendingUsers.map((user) => (
                    <div key={user.id} className="border rounded-md p-4 mb-4">
                        ...
                        <div className="mt-4">
                            ...
                            <button onClick={() => handleReject(user.id)} className="bg-rose-500  text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition-all duration-200">
                                Reject
                            </button>
                            <button onClick={() => handleUserClick(user.id)} className="text-blue-500 hover:underline ml-4 cursor-pointer">View Details</button>
                        </div>
                    </div>
                ))}
            </div>
